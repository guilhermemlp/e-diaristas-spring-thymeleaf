...
public class ServicoController {
    ...
    public String cadastrar(@Valid @ModelAttribute("form") ServicoFormDTO form, BindingResult result, RedirectAttributes attributes) {
        if (result.hasErrors()) {
    ...
    public String editar(@PathVariable Long id, @Valid @ModelAttribute("form") ServicoFormDTO form,
